...
const CourseCardHorizontal = ({
  ...
  return (
    <div
      className="group relative h-80 w-293 flex bg-white rounded-2xl overflow-hidden border border-gray-200 transition-transform duration-300 hover:shadow-2xl hover:-translate-y-2 hover:bg-gray-50 cursor-pointer"
      onClick={handleClick}
    >
      {/* Left: Image + Category Badge */}
      <div className="relative w-120 bg-gray-100">
