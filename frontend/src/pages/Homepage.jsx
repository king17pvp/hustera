...
const Homepage = ({ categories, testimonials, threads, stats, courses }) => {
  return (
    <>
      ...
      <div className="max-w-[1780px] mx-auto px-10 mt-20 mb-20">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-5xl font-bold font-avant-medium">Popular Courses</h2>
        ...
        <div className="grid grid-cols-3 gap-7">
          {courses.slice(0, 3).map((course) => (
            <CoursesCard
              ...
              courseID={course.courseID || course.id || 1}
